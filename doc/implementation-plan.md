...
**Requirements:** §10 (API surface declaration only), §11 harness shape.

**Interfaces produced:**
- `zeroskip.h`: the complete public surface from §10 — `enum zs_ret`, `enum
...
enum zs_ret {
    ...
    ZS_IOERROR      = -2,
    ZS_INTERNAL     = -3,
    ZS_LOCKED       = -4,   /* pinned by §10 */
    ZS_NOTFOUND     = -5,   /* pinned by §10 */
    ZS_READONLY     = -6,
    ZS_BADFORMAT    = -7,   /* pinned by §10 */
    ZS_BADUSAGE     = -8,
    ZS_BADCHECKSUM  = -9,
    ZS_FULL         = -10,
    ZS_AGAIN        = -11,
...
**Flags** — one 32-bit space, never reused across calls (§10):
...
Transcribe §10's declarations exactly, with the enums above. Include
...
**Requirements:** §10 — A-0, A-1b, A-2, A-3, A-4, A-5, A-7; T-4
...
**Spec open items (§13)** are deliberately not addressed: repack duration stays
